/*
=================================================================
Store Procedure: Load data for silver layer
=================================================================
Script Purpose: 
	This store procedure loads data into the silver schema from bronze layers.
	It performs the following actions:
		- Truncate the tables before loading data.
		- Load cleaned and transformed data from bronze tables.
Parameter:
	None
